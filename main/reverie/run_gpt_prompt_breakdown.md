...
Prompt validate functions (validate answers that are received from LLM)
...
Output:
    ...
    A random number for the persona's target wake-up time between 'i' and 'j'
...
Output:
    ...
    A schedule specific to the current hour, based on information of what came before in the schedule.
...
## Partial Continuation of run_gpt_prompt_generate_hourly_schedule()
